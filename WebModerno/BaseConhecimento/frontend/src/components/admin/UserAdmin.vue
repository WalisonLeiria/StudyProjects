        ...
        <b-col md="6" sm="12">
          <b-form-group label="Nome:" label-for="user-name">
            <b-form-input id="user-name" type="text" v-model="user.name"
              ...
              required placeHolder="Informe o nome do usuário"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col md="6" sm="12">
          <b-form-group label="E-mail:" label-for="user-email">
            <b-form-input id="user-email" type="text" v-model="user.email"
              :readonly="mode === 'remove'"
              required placeHolder="Informe o e-mail do usuário"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
        ...
        <b-col md="6" sm="12">
          <b-form-group label="Senha:" label-for="user-password">
            <b-form-input id="user-password" type="password" v-model="user.password"
              required placeHolder="Informe a senha!"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col md="6" sm="12">
          <b-form-group label="Confirme a senha:" label-for="user-confirm-password">
            <b-form-input id="user-confirm-password" type="password" v-model="user.confirmPassword"
              required placeHolder="Confirme a senha!"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
  ...
  data: function() {
    return {
      ...
      fields: [
        ...
        { key: "email", label: "E-mail", sorteble: true },
        { key: "admin", label: "Administrador", sorteble: true, formatter: value => value ? "Sim" : "Não" },
